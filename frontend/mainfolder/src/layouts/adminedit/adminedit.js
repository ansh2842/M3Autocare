...
function SignUp() {
   ...
   const handleChange = (e) => {
    ...
    if(adminData.name !=='' && adminData.email !=='' && adminData.contact !=='' && adminData.password !==''){
      try {
      ...
      <Card>
        ...
        <SoftBox pt={2} pb={3} px={3}>
          <SoftBox component="form" role="form">
            <SoftBox mb={2}>
            <SoftInput  value={adminData.name} onChange={handleChange} name="name" placeholder="Name" />
            </SoftBox>
            <p style={{marginTop:'-16px', color:'red', fontSize:'11px'}}>{nameError}</p>
            <SoftBox mb={2}>
              <SoftInput value={adminData.email} onChange={handleChange} name="email"  type="email" placeholder="Email" />
            </SoftBox>
            ...
            <SoftBox mb={2}>
              <SoftInput value={adminData.contact} onChange={handleChange} name="contact"  type="number" placeholder="Contact" />
            </SoftBox>
            <SoftTypography >
            ...
            <SoftBox mb={2}>
              <SoftInput  onChange={handleChange} name="password" type="password" placeholder="Password" />
            </SoftBox>
