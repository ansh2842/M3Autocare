...
const subCategoryManagement = () => {
  ...
  const currentAppointments = getDataAbout.slice(indexOfFirstAppointment, indexOfLastAppointment);
  ...
  const pageNumbers = [];
  for (let i = 1; i <= Math.ceil(getDataAbout.length / appointmentsPerPage); i++) {
    pageNumbers.push(i);
  }
  ...
  const handleAdd = async () => {
    ...
    await axios
      .post("http://localhost:8000/admin/aboutpost", formData, {
    ...
    <DashboardLayout>
      ...
      <div>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>About details</DialogContentText>
            <SoftBox mb={2}>
              <SoftInput
                type="file"
            ...
            <p style={{ marginTop: "-12px", color: "red", fontSize: "11px" }}></p>
            ...
            <SoftBox mb={2}>
              ...
              <textarea
                ...
                onChange={(e) => setValuesData(e.target.value)}
            ...
            <SoftBox mb={2}>
              ...
              <textarea
                ...
                onChange={(e) => setMissonData(e.target.value)}
