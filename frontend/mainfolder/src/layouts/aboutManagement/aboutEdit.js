    ...
    <Card>
        ...
        <SoftBox pt={2} pb={3} px={3}>
            <SoftBox component="form" role="form">
                ...
                <textarea id="content_about" style={{width:'100%',borderRadius:'7px',fontSize:'14px',paddingLeft:'4px',outline:'none'}} value={AboutData.about} onChange={handleChange} name="about" type="text" placeholder="About Description" />
                </SoftBox>
                <p style={{ color: "red", fontSize: "11px" }}>{titleError}</p>
            <SoftBox mb={2}>
            <label style={{fontSize:'16px'}}>Our value description</label>
            <textarea id="content_about2" value={AboutData.valuedata}   onChange={(e) => setAboutData({ ...AboutData, valuedata: e.target.value })} name='valuedata' placeholder='Our Value Description' />
            </SoftBox>
            <SoftBox mb={2}>
            <label style={{fontSize:'16px'}}>Mission description</label>
            <textarea id="content_about3" value={AboutData.missiondata} name='missiondata'  onChange={(e) => setAboutData({ ...AboutData, missiondata: e.target.value })} placeholder='Our mission Description' />
            </SoftBox>
            <SoftBox mb={2}>
            <label style={{fontSize:'16px'}}>Choose description</label>
            <textarea id="content_about4" value={AboutData.choosedata}   onChange={(e) => setAboutData({ ...AboutData, choosedata: e.target.value })} name='choosedata' placeholder='Our Value Description' />
            </SoftBox>
            <SoftBox mb={2}>
            <label style={{fontSize:'16px'}}>Journey description</label>
            <textarea id="content_about5" value={AboutData.journeydata} name='journeydata'  onChange={(e) => setAboutData({ ...AboutData, journeydata:e.target.value  })} placeholder='Our journey Description' />
            </SoftBox>
                <SoftBox mt={4} mb={1}>
