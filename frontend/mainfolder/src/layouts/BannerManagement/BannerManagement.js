...
const subCategoryManagement = () => {
  ...
  const handleAdd = async () => {
    ...
    } else setDesciprionError("");

    if (image !== "" && title !== "" && description !== "") {
      axios
        .post("http://localhost:8000/admin/banneradd", formData, {
          headers: {
    ...
    <DashboardLayout>
      ...
      <div>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>Banner details</DialogContentText>
            <SoftBox mb={2}>
              <SoftInput
            ...
            <p style={{ marginTop: "-12px", color: "red", fontSize: "11px" }}>{descriptionError}</p>
          </DialogContent>
          <DialogActions>
