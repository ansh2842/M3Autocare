    ...
    <div>
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className={styles.navbar_nav}>
                  ...
                  {loginHide && (
                    <li className={styles.nav_item}>
                      <Link>
                        <a onClick={logDropdowns} className={styles.nav_link}>
                          <FontAwesomeIcon icon={faUser} aria-hidden="true" /> User{" "}
      ...
      <div className={styles2.boxy}>
        {isDropdownOpen && (
          <div className={styles2.dropdown}>
            <ul>
              <Link to={`/Users-Profile/${name.id}`}>
                <li className={styles2.texts3}>Profile </li>
              </Link>
              <Link to={`/appointment/${name.id}`}>
                <li className={styles2.texts3}>Appointment </li>
              </Link>
              <Link to={`/checkappointment/${name.id}`}>
                <li className={styles2.texts3}>Check Appoinments </li>
              </Link>
              <Link to={`/UserChangePassword/${name.id}`}>
                {" "}
                <li className={styles2.texts3}>Change password</li>
              </Link>

              <li onClick={handleClickOpens} className={styles2.texts3}>
          ...
          <div className={styles.mainn}>
            <div className={styles.mainhead}>
              <ul className={styles.ullist}>
                ...
                <Link to={"/user-product/:id"}>
                  {" "}
                  <li className={styles.lists}>Products</li>
                </Link>
                <Link to={`/appointment/${name.id}`}>
                  <li className={styles2.texts3}>Appointment </li>{" "}
                </Link>
                ...
                <Link to={"/user-contact"}>
                  {" "}
                  <li className={styles.lists}>Contact Us</li>
                </Link>
                <Link to={"/user-login"}>
                  <li className={styles2.texts3}>Login </li>{" "}
                </Link>
      ...
      <div>
        <Dialog
          ...
          maxWidth={"sm"}
        >
          <DialogTitle id="alert-dialog-title" style={{fontFamily: "Onest, sans-serif"}}>Appointment Cancel</DialogTitle>
          <DialogContent>
            <DialogContentText style={{ fontSize: "14px",fontFamily: "Onest, sans-serif",color:'black' }} id="alert-dialog-description">
