      ...
      <div className={styles.mainBox}>
        <div className={styles.box}>
          ...
          <div className={styles.forms}>
            <form>
              <label className={styles.text}>Old password</label>
              <br />
              <div className={styles.box3}>
                <input
                  ...
                  type={type2}
                ></input>
                <FontAwesomeIcon onClick={HandleChnages} className={styles.icon} icon={icon2} />
              </div>
              {invalids && (
                <p style={{ marginTop: "0", color: "green", fontSize: "11px" }}>{invalids}</p>
              )}
              <label className={styles.text}>Create new password</label>
              <br />
              <div className={styles.box3}>
                <input
                  className={styles.input}
              ...
              <div className={styles.box3}>
                <input
                  ...
                  type={type3}
                ></input>
                <FontAwesomeIcon onClick={HandleChnaged} className={styles.icon} icon={icon3} />
              </div>
              {invalid && (
