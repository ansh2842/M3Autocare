...
function appoinment() {
  ...
  const handleServiceChange = (event) => {
    ...
    const selectedService = getService.find((item) => item._id === selectedServiceId);
            ...
            <div className="row">
              <div className="col-md-4">
                <div className={`booking-cta`}>
                  <h1 style={{ color: "#0a97b0", fontWeight: "700" }} className={styles.headBook}>
                    Book your Service{" "}
                    <span style={{ color: "#0a97b0", fontWeight: "700" }}>today!</span>{" "}
                  </h1>
                  <p className={styles.texttmedia}>
                    Take an appointment with us and enjoy your day
                  </p>
                </div>
              </div>
                  ...
                  <form>
                      ...
                      <div className="form-checkbox">
                        <label htmlFor="roundtrip">
                          <p className={styles.apptext}>
                            ...
                            <span style={{ color: "#0a97b0" }}> M3 AUTOCARE</span>
                          </p>
                    ...
                    <div className="row">
                      <div className="col-md-6 ">
                        <div className="form-group">
                          <span className="form-label" style={{ color: "#0a97b0" }}>
                            Name
                          </span>
                          <input
                        ...
                        <div className="form-group">
                          ...
                          >
                            {getServiceId.name.length > 0 ? (
                              ...
                              <>
                                <option selected disabled value="Choose Service">
                                  Choose Service
                                </option>
                                {!getService ? (
          ...
          <div className="row">
            <div className={`col-md-6 col-lg-4 ${styles.info_col}`}>
              <div className={styles.info_contact}>
                <h4 style={{ fontFamily: "Onest, sans-serif" }}>Address</h4>
            ...
            <div className={`col-md-6 col-lg-4 ${styles.info_col}`}>
              <div className={styles.info_detail}>
                <h4 style={{ fontFamily: "Onest, sans-serif" }}>Info</h4>
                <p style={{ fontFamily: "Onest, sans-serif", fontSize: "17px" }}>
                  we M3AUTOCARE , we are your trusted partner in ensuring a smooth and enjoyable
                  driving experience. Our journey began 1995 with a vision to revolutionize the way
                  car services are delivered, and we have been steering toward that goal ever since.
                </p>
              </div>
            </div>
                ...
                <div className={styles.info_links}>
                  <Link to={"/home?" + Date.now()}>
                    ...
                    <a
                      ...
                      href="index.html"
                      style={{ fontFamily: "Onest, sans-serif", fontSize: "17px" }}
                    >
