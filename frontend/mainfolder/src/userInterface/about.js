  ...
  <div className='container'>
    <div className="row">
      ...
      {getDataAbout.map((item)=>(
       ...
       {getDataAbout.map((item) => (
          <div  key={item.id} >
          <p  style={{fontFamily:'Onest, sans-serif'}} dangerouslySetInnerHTML={{ __html: item.valuedata }}></p><br/>
          <p  style={{fontFamily:'Onest, sans-serif'}} dangerouslySetInnerHTML={{ __html: item.choosedata }}></p><br/>
          <p  style={{fontFamily:'Onest, sans-serif'}} dangerouslySetInnerHTML={{ __html: item.journeydata }}></p><br/>
        </div>
      ))}
    </div>
  </div>
