...
exports.editByID =  asyncHandler(async(req,res)=>{
    const {id} = req.params
    const {about,head,value,mission,valuedata,missiondata,choose,journey,choosedata,journeydata} = req.body
    ...
    try{
        ...
        update.choosedata = choosedata,
        update.journeydata = journeydata
